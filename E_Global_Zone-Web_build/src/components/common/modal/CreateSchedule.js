...
export default function CreateSchedule({
  ...
  const [std_for_name, set_std_for_name] = useState(
    std_for_list[0].std_for_name
  );
    ...
    setData({
      ...
      schedule: [
        ...data.schedule,
        {
          ...
          std_for_name,
          sch_type,
          sch_location: sch_type === "offline" ? location : null,
      ...
      <div className="btn_area right">
        <div
          ...
          onClick={() => {
            ...
            postAdminScheduleSome(requestData).then((res) => {
              handleClose();
            });
          }}
        >
