...
export const patchAdminScheduleApproval = (sch_id, data) => admin.patch(`schedule/approval/${sch_id}`, data);
...
export const patchAdminScheduleLocation = (sch_id, location) =>
  admin.patch(`schedule/location/${sch_id}`, { sch_location: location }).then((res) => {
    alert(res.data.message);
    return res;
  });
